  ...
  _createClass(Model, [{
    ...
    value: function init() {
      var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          ...
          bufferMode = _ref$bufferMode === undefined ? _webgl.GL.SEPARATE_ATTRIBS : _ref$bufferMode,
    ...
    value: function _initializeProgram(_ref5) {
      ...
      if (!program) {
        ...
        if (shaderCache) {
          ...
          program = new _webgl.Program(this.gl, { vs: vs, fs: fs, varyings: varyings, bufferMode: bufferMode });
        }
