...
var isPageLoaded = _utils.isBrowser && document.readyState === 'complete'; // Resizing a webgl canvas

/* global window, document */


var pageLoadPromise = _utils.isBrowser ? new Promise(function (resolve, reject) {
  if (isPageLoaded) {
    resolve(document);
    return;
  }
